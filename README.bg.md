...
### 0. Инсталация през PyPI (Препоръчително за CLI и Python проекти)
```bash
pip install openbalancer

# Стартиране на интерактивен демо сандбокс с 3 вградени бекенда:
openbalancer demo

# Или стартиране с ваша собствена конфигурация:
